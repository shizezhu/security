 ...
 */
	...
	$.jstree.plugins.checkbox = function (options, parent) {
		 ...
		 * @plugin checkbox
		 */
		this.check_node = function (obj, e, supress_event) {
			if(this.settings.checkbox.tie_selection) { return this.select_node(obj, false, true, e); }
			var dom, t1, t2, th;
			if($.isArray(obj)) {
				obj = obj.slice();
				for(t1 = 0, t2 = obj.length; t1 < t2; t1++) {
					this.check_node(obj[t1], e, supress_event);
				}
				return true;
			}
			obj = this.get_node(obj);
			...
			if(!obj.state.checked) {
				 ...
				 * @plugin checkbox
				 */
				this.trigger('check_node', { 'node' : obj, 'selected' : this._data.checkbox.selected, 'event' : e, "my_supress_event"  : supress_event});
			}
		};
		/**
		 ...
		 * @plugin checkbox
		 */
		this.uncheck_node = function (obj, e, supress_event) {
			if(this.settings.checkbox.tie_selection) { return this.deselect_node(obj, false, e); }
			var t1, t2, dom;
			if($.isArray(obj)) {
				obj = obj.slice();
				for(t1 = 0, t2 = obj.length; t1 < t2; t1++) {
					this.uncheck_node(obj[t1], e, supress_event);
				}
				return true;
			}
			obj = this.get_node(obj);
			...
			if(obj.state.checked) {
				 ...
				 * @plugin checkbox
				 */
				this.trigger('uncheck_node', { 'node' : obj, 'selected' : this._data.checkbox.selected, 'event' : e, "my_supress_event"  : supress_event });
			}
		};
		/**
