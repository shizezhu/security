...
<title>小石权限系统 -修改角色</title>
<script type="text/javascript">
	$(function() {
		$ .myAjaxForm("form", {
			url : "${pageContext.request.contextPath}/role/smUpdate",
			data : {"menu" :  function() {
		...
		$('#tree').jstree({
			...
			$.myAjax({
				url : "${pageContext.request.contextPath}/rolemenu/listMenuIdByRoleId",
				data : {"roleId" : '${role.id }'},
				success : function(result) {
					if (result) {
						var jstree = $('#tree').jstree(true);
						jstree.check_node(result, null, true);
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input name="descr" type="text"
										class="form-control" value="${role.descr }">
								</div>
							</div>
							<div class="form-group">
